...
func (app *application) little() {
	...
	row2Col1 := makeBoundItem(ampPower, color.White, false)
	row2Col2 := makeBoundItem(refPower, color.White, false)
	row2Col3 := makeBoundItem(swr, color.White, false)

	row4Col1 := makeBoundItem(airTemp, color.White, false)
	row4Col2 := makeBoundItem(sinkTemp, color.White, false)
	row4Col3 := makeBoundItem(doorStatus, color.White, false)

	row6Col1 := makeBoundItem(fan1, color.White, false)
	row6Col2 := makeBoundItem(fan2, color.White, false)
	row6Col3 := makeBoundItem(pttStatus, color.White, false)
...
func makeBoundItem(b binding.String, clr color.Color, bld bool) *fyne.Container {
